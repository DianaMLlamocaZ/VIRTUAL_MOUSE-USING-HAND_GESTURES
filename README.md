...
<p align="center">
  <sub>Distancia entre los dedos índice y pulgar a medida que ambos se acercan a la cámara</figcaption></sub>
</p>
...
#### <ins>**7.1) VECTORES Y MATRICES DEFINIDOS**</ins>
  -  **Vector de estado (x)**:
  ...
  -  **Matriz de transición (F)**:
      - Calcula la predicción utilizando la fórmula de velocidad constante definida en la matriz: aplica la física del movimiento.
  ...
  -  **Fórmula**:
      - En conjunto, el vector de estado 'x' y la matriz 'F' representan un modelo de velocidad constante que aplican la fórmula física:
